...
#For the subclass Grass_Pokemon, add another method called action that returns the
#string "[name of pokemon] knows a lot of different moves!". Create an instance of
#this class with the name as "Belle". Assign this instance to the variable p1.
...
#instances does not change until they reach level 10. At level 10 and up, their attack
#strength should increase by the attack_boost amount when they are trained.
...
#use Grass_Pokemon methods to train the p3 Grass_Pokemon instance until it reaches at
# least level 10.
...
#Call it opponent. It should return which type of pokemon the current type is weak
#and strong against, as a tuple.
